...
#+TAGS: REVIEW(r) ORGMODE(o) SHORTCUT(s) 
...
** NEXT E02S01 : Tags                                         :TAGS:ORGMODE:
   :PROPERTIES:
   :Effort:   10:00
   :END:
   :CLOCKLOG:
   CLOCK: [2020-02-12 Wed 08:41]
   :END:
...
** NEXT E02S02 : Agenda view (advanced)
** NEXT E02S03 : Customized Agenda view
** NEXT E02S05 : Archiving.mp4
** NEXT E03S01 : Automatic logging of status changes
** NEXT E03S02 : Splitting your system up to several files
** NEXT E03S03 : The first capture template(s)
** NEXT E03S04 : The  -PROPERTIES - drawer
** NEXT E03S05 : Archiving to different files
** NEXT E04S01 : Ordered tasks
** NEXT E04S02 : Timers
** NEXT E04S03 : Clocking (aka time tracking)
** NEXT E04S04 : Column view
** NEXT E04S05 : Effort estimates
** NEXT E05S01 : Linking (internal)
** NEXT E05S02 : Linking (external)
** NEXT E05S03 : Attachments
** NEXT E05S04 : Priorities
** NEXT E05S05 : Tables
** NEXT E06S01 : Exporting
** NEXT E06S02 : Advanced exporting
** NEXT E06S03 : Publishing
** NEXT E06S04 : Dynamic blocks
...
** NEXT E07S04 : Source code in OrgMode
** NEXT E07S05 :
* Use Emacs
** TODO 62 : Magit
   :CLOCKLOG:
...
** magit
   ...
   9. use @@html:<kbd>@@ f @@html:</kbd>@@ to fetch repo files.
